    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.authorContainer}>
        <div className={styles.authorProfileImageContainer}>
          <Image src={JAB} width={100} height={100} />
        </div>

        <div className={styles.authorName}> Momoh jabbar</div>
      ...
      <div className={styles.recommendationContainer}>
        ...
        <div className={styles.aticlesContainer}>
...
const recommendedPosts = [
  ...
  {
    title: "Why web development is crucial for the next generation ",
    image: WEBDEV,
    author: {
      name: "Abdul Jabbar",
      image: JAB,
  ...
  {
    title: "Roadmap to master javacript and start building",
    image: JsLogo,
    author: {
      name: "Javascript Legend ",
      image: Legend,
    },
  },
];
